        ...
        <div className="w-full grid grid-cols-7">
          ...
          {sortedData.map(row =>
            COLUMNS.map(col => {
              ...
              const isEditable = ['Pilot Estimate', 'Altitude', 'Mach'].includes(col) && !row.locked;
...
//               // } 
              ...
              if (isCoord) {
                ...
                console.log(textColor);
                if (isCenterTime && pilotRaw.length === 4 && !isNaN(pilotTimeMins)) {
              ...
              return (
                ...
                <div
                  key={`${row.id}-${col}`}
                  className={`${bgColor} p-2 text-sm text-center border-b border-r border-gray-800 ${isCoord ? 'cursor-pointer' : ''}`}
